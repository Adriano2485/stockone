...
dependencies:
  ...
  pdf: ^3.11.3
  image_picker: ^1.0.4
  intl: ^0.19.0        # ⬅️ CORRIGIDO: 0.20.2 → 0.19.0
  path_provider: ^2.1.5
...
flutter:
  ...
  assets:
    ...
    - assets/images/StockOnesf.png
    - assets/images/bh.jpg
    - assets/images/paisefilhos.jpg
    ...
    - assets/images/baixas8949.png
    - assets/images/baixas2371.png
    - assets/images/catalogo.png
    - assets/images/etiquetavalidade.png
    - assets/images/mapaentregas.png
    - assets/images/insumos.png
    - assets/images/folhapedido.png
    - assets/images/Mart-Minas.jpg
...
flutter_icons:
  android: true
  ios: true
  image_path: "assets/images/iconeapp2.jpg" # seu ícone
  adaptive_icon_background: "#ffffff" # fundo para Android adaptativo
  adaptive_icon_foreground: "assets/images/iconeapp2.jpg"
